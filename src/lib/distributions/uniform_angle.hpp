...
namespace distributions {
    /**
     * Samples uniformly a direction so that the area density of generated points is uniform.
    ...
    public:
        ...
        /**
         * Sampling method. Uses a sin distribution on the polar angle to achieve surface density uniformity.
         * @param rng The random generator used to sample points.
         * @return A triplet of cartesian coordinates representing a versor.
         */
