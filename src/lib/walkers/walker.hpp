...
public:
    ...
    /**
     * Performs a single step from the current position and updates it.
    ...
    /**
     * Performs a random walk from the current position and stores it.
    ...
    /**
     * Performs a random walk from the current position and returns the ending point.
