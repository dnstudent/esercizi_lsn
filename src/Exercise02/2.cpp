...
/**
 * Factory method for a walker performing length 1 steps along 3D axes.
 */
 ...
 */
template<typename WalkerFactory, typename URBG>
void fill_walk_statistics(WalkerFactory walker_factory, URBG &rng, size_t n_blocks,
    ...
    table.InsertColumn(table.GetColumnCount() - 1, estimates, section + "_mean");
    table.InsertColumn(table.GetColumnCount() - 1, uncerts, section + "_error");
}
